...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom(NgProgressHttpModule, NgProgressRouterModule, NgxPermissionsModule.forRoot(), ToastrModule.forRoot(), TranslateModule.forRoot({
        loader: {
    ...
    MatMomentDateModule, MtxMomentDatetimeModule),
